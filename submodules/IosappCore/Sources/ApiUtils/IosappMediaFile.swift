...
func dimensionsForFileAttributes(_ attributes: [IosappMediaFileAttribute]) -> PixelDimensions? {
...
func durationForFileAttributes(_ attributes: [IosappMediaFileAttribute]) -> Double? {
    for attribute in attributes {
        switch attribute {
...
public extension IosappMediaFile {
...
public func fileNameFromFileAttributes(_ attributes: [IosappMediaFileAttribute]) -> String? {
    for attribute in attributes {
