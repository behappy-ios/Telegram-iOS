...
public func updateLoggingSettings(accountManager: AccountManager<IosappAccountManagerTypes>, _ f: @escaping (LoggingSettings) -> LoggingSettings) -> Signal<Void, NoError> {
