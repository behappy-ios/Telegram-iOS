...
public final class IosappEngine {
...
public final class IosappEngineUnauthorized {
...
public enum SomeIosappEngine {
    case unauthorized(IosappEngineUnauthorized)
    case authorized(IosappEngine)
}
