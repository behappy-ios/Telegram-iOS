...
public final class IosappCollectibleItemInfo: Equatable {
    ...
    public static func ==(lhs: IosappCollectibleItemInfo, rhs: IosappCollectibleItemInfo) -> Bool {
        if lhs === rhs {
            return true
        }
...
public final class IosappResolvedMessageLink {
...
public enum IosappPaidReactionPrivacy: Equatable, Codable {
    case `default`
    case anonymous
    case peer(PeerId)
...
public extension IosappEngine {
    ...
    final class Peers {
        ...
        public func reorderAddressNames(domain: AddressNameDomain, names: [IosappPeerUsername]) -> Signal<Void, ReorderAddressNamesError> {
        ...
        public func adminedPublicChannels(scope: AdminedPublicChannelsScope = .all) -> Signal<[IosappAdminedPublicChannel], NoError> {
        ...
        public func updateChannelMemberBannedRights(peerId: PeerId, memberId: PeerId, rights: IosappChatBannedRights?) -> Signal<(ChannelParticipant?, RenderedChannelParticipant?, Bool), NoError> {
            return _internal_updateChannelMemberBannedRights(account: self.account, peerId: peerId, memberId: memberId, rights: rights)
        }

        public func updateDefaultChannelMemberBannedRights(peerId: PeerId, rights: IosappChatBannedRights) -> Signal<Never, NoError> {
        ...
        public func requestPeerPhotos(peerId: PeerId) -> Signal<[IosappPeerPhoto], NoError> {
        ...
        public func updateChannelAdminRights(peerId: PeerId, adminId: PeerId, rights: IosappChatAdminRights?, rank: String?) -> Signal<(ChannelParticipant?, RenderedChannelParticipant), UpdateChannelAdminRightsError> {
        ...
        public func addChannelMembers(peerId: PeerId, memberIds: [PeerId]) -> Signal<IosappInvitePeersResult, AddChannelMemberError> {
        ...
        public func setMainProfileTab(peerId: EnginePeer.Id, tab: IosappProfileTab) -> Signal<Never, NoError> {
        ...
        public func suggestBirthday(peerId: EnginePeer.Id, birthday: IosappBirthday) -> Signal<Never, SuggestBirthdayError> {
            ...
            return self.account.postbox.transaction { transaction -> (peer: EnginePeer, unreadCount: Int, location: NextUnreadChannelLocation)? in
                func getForFilter(predicate: ChatListFilterPredicate?, isArchived: Bool) -> (peer: EnginePeer, unreadCount: Int)? {
                    ...
                    for listId in peerIds {
                        ...
                        guard let channel = peer as? IosappChannel, case .broadcast = channel.info else {
                            continue
                        }
        ...
        public func mostRecentSecretChat(id: EnginePeer.Id) -> Signal<EnginePeer.Id?, NoError> {
            return self.account.postbox.transaction { transaction -> EnginePeer.Id? in
                ...
                for associatedId in filteredPeerIds {
                    if let state = (transaction.getPeer(associatedId) as? IosappSecretChat)?.embeddedState {
                        switch state {
        ...
        public func resetAllPeerNotificationSettings() -> Signal<Never, NoError> {
            return self.account.postbox.transaction { transaction -> Void in
                transaction.resetAllPeerNotificationSettings(IosappPeerNotificationSettings.defaultSettings)
            }
            |> ignoreValues
        }
        ...
        public func subscribeIsPremiumRequiredForMessaging(id: EnginePeer.Id) -> Signal<Bool, NoError> {
            ...
            |> map { views -> Bool in
                ...
                guard let user = basicPeerView.peer as? IosappUser else {
                    return false
                }
        ...
        public func getCollectibleUsernameInfo(username: String) -> Signal<IosappCollectibleItemInfo?, NoError> {
            ...
            |> map { result -> IosappCollectibleItemInfo? in
                ...
                case let .collectibleInfo(collectibleInfoData):
                    ...
                    return IosappCollectibleItemInfo(
        ...
        public func getCollectiblePhoneNumberInfo(phoneNumber: String) -> Signal<IosappCollectibleItemInfo?, NoError> {
        ...
        public func updateBotBiometricsState(peerId: EnginePeer.Id, update: @escaping (IosappBotBiometricsState?) -> IosappBotBiometricsState) {
        ...
        public func resolveMessageLink(slug: String) -> Signal<IosappResolvedMessageLink?, NoError> {
            ...
            |> mapToSignal { result -> Signal<IosappResolvedMessageLink?, NoError> in
                guard let result else {
                    return .single(nil)
                }
                return self.account.postbox.transaction { transaction -> IosappResolvedMessageLink? in
                    switch result {
                    case let .resolvedBusinessChatLinks(resolvedBusinessChatLinksData):
                        ...
                        return IosappResolvedMessageLink(
