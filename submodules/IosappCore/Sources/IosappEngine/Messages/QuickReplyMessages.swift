...
public final class IosappBusinessRecipients: Codable, Equatable {
    ...
    public static func ==(lhs: IosappBusinessRecipients, rhs: IosappBusinessRecipients) -> Bool {
        if lhs === rhs {
            return true
        }
...
public final class IosappBusinessGreetingMessage: Codable, Equatable {
    private enum CodingKeys: String, CodingKey {
        case shortcutId
        case recipients
        case inactivityDays
    ...
    public let recipients: IosappBusinessRecipients
    public let inactivityDays: Int
    
    public init(shortcutId: Int32, recipients: IosappBusinessRecipients, inactivityDays: Int) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.recipients = try container.decode(IosappBusinessRecipients.self, forKey: .recipients)
    ...
    public static func ==(lhs: IosappBusinessGreetingMessage, rhs: IosappBusinessGreetingMessage) -> Bool {
        if lhs === rhs {
            return true
        }
...
extension IosappBusinessGreetingMessage {
    convenience init(apiGreetingMessage: Api.BusinessGreetingMessage) {
        ...
        case let .businessGreetingMessage(businessGreetingMessageData):
            ...
            self.init(
                ...
                recipients: IosappBusinessRecipients(apiValue: recipients),
...
public final class IosappBusinessAwayMessage: Codable, Equatable {
    ...
    public init(shortcutId: Int32, recipients: IosappBusinessRecipients, schedule: Schedule, sendWhenOffline: Bool) {
        self.shortcutId = shortcutId
        self.recipients = recipients
    ...
    public static func ==(lhs: IosappBusinessAwayMessage, rhs: IosappBusinessAwayMessage) -> Bool {
        if lhs === rhs {
            return true
        }
...
public final class IosappBusinessIntro: Codable, Equatable {
    private enum CodingKeys: String, CodingKey {
        case title
        case text
        case stickerFile
    ...
    public let stickerFile: IosappMediaFile?
    
    public init(title: String, text: String, stickerFile: IosappMediaFile?) {
        self.title = title
        self.text = text
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let stickerFileData = try container.decodeIfPresent(Data.self, forKey: .stickerFile) {
            self.stickerFile = IosappMediaFile(decoder: PostboxDecoder(buffer: MemoryBuffer(data: stickerFileData)))
        } else {
    ...
    public static func ==(lhs: IosappBusinessIntro, rhs: IosappBusinessIntro) -> Bool {
...
extension IosappBusinessAwayMessage {
...
extension IosappBusinessIntro {
    ...
    func apiInputIntro() -> Api.InputBusinessIntro {
        ...
        if let stickerFile = self.stickerFile {
            if let fileResource = stickerFile.resource as? CloudDocumentMediaResource, let resource = stickerFile.resource as? IosappCloudMediaResourceWithFileReference, let reference = resource.fileReference {
                flags |= 1 << 0
...
extension IosappBusinessBotRights {
    init(apiValue: Api.BusinessBotRights) {
        var value: IosappBusinessBotRights = []
        switch apiValue {
...
extension IosappBusinessRecipients {
...
func _internal_updateBusinessGreetingMessage(account: Account, greetingMessage: IosappBusinessGreetingMessage?) -> Signal<Never, NoError> {
...
func _internal_updateBusinessAwayMessage(account: Account, awayMessage: IosappBusinessAwayMessage?) -> Signal<Never, NoError> {
    let remoteApply = account.postbox.transaction { transaction -> [Peer] in
...
func _internal_updateBusinessIntro(account: Account, intro: IosappBusinessIntro?) -> Signal<Never, NoError> {
...
public final class IosappAccountConnectedBot: Codable, Equatable {
    public let id: PeerId
    public let recipients: IosappBusinessRecipients
    public let rights: IosappBusinessBotRights
    
    public init(id: PeerId, recipients: IosappBusinessRecipients, rights: IosappBusinessBotRights) {
        self.id = id
        self.recipients = recipients
        self.rights = rights
    }
    
    public static func ==(lhs: IosappAccountConnectedBot, rhs: IosappAccountConnectedBot) -> Bool {
        if lhs === rhs {
            return true
        }
        if lhs.id != rhs.id {
...
public struct IosappBusinessBotRights: OptionSet, Codable {
    public var rawValue: Int32
    ...
    public static let reply = IosappBusinessBotRights(rawValue: 1 << 0)
    public static let readMessages = IosappBusinessBotRights(rawValue: 1 << 1)
    public static let deleteSentMessages = IosappBusinessBotRights(rawValue: 1 << 2)
    public static let deleteReceivedMessages = IosappBusinessBotRights(rawValue: 1 << 3)
    public static let editName = IosappBusinessBotRights(rawValue: 1 << 4)
    public static let editBio = IosappBusinessBotRights(rawValue: 1 << 5)
    public static let editProfilePhoto = IosappBusinessBotRights(rawValue: 1 << 6)
    public static let editUsername = IosappBusinessBotRights(rawValue: 1 << 7)
    public static let viewGifts = IosappBusinessBotRights(rawValue: 1 << 8)
    public static let sellGifts = IosappBusinessBotRights(rawValue: 1 << 9)
    public static let changeGiftSettings = IosappBusinessBotRights(rawValue: 1 << 10)
    public static let transferAndUpgradeGifts = IosappBusinessBotRights(rawValue: 1 << 11)
    public static let transferStars = IosappBusinessBotRights(rawValue: 1 << 12)
    public static let manageStories = IosappBusinessBotRights(rawValue: 1 << 13)
    
    public static let All: IosappBusinessBotRights = [
        .reply,
        .readMessages,
        .deleteSentMessages,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self = IosappBusinessBotRights(rawValue: value ?? 0)
    }
...
public func _internal_setAccountConnectedBot(account: Account, bot: IosappAccountConnectedBot?) -> Signal<Never, NoError> {
...
func _internal_updatePersonalChannel(account: Account, personalChannel: IosappPersonalChannel?) -> Signal<Never, NoError> {
    let remoteApply = account.postbox.transaction { transaction -> Peer? in
