...
public final class StoryStealthModeInfoContentComponent: Component {
    ...
    public final class View: UIView {
        ...
        func update(component: StoryStealthModeInfoContentComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: ComponentTransition) -> CGSize {
