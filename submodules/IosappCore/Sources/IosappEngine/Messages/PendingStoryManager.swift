...
public extension Stories {
    ...
    final class PendingItem: Equatable, Codable {
        ...
        public let embeddedStickers: [IosappMediaFile]
        public let pin: Bool
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.embeddedStickers = (try? stickersDecoder.decodeObjectArrayWithCustomDecoderForKey("stickers", decoder: { IosappMediaFile(decoder: $0) })) ?? []
