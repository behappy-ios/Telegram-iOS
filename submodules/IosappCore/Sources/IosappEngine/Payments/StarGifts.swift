...
public enum StarGift: Equatable, Codable, PostboxCoding {
    ...
    public struct Gift: Equatable, Codable, PostboxCoding {
        ...
        public init(id: Int64, title: String?, file: IosappMediaFile, price: Int64, convertStars: Int64, availability: Availability?, soldOut: SoldOut?, flags: Flags, upgradeStars: Int64?, releasedBy: EnginePeer.Id?, perUserLimit: PerUserLimit?, lockedUntilDate: Int32?, auctionSlug: String?, auctionGiftsPerRound: Int32?, auctionStartDate: Int32?, upgradeVariantsCount: Int32?, background: Background?) {
            self.id = id
            self.title = title
            self.file = file
            self.price = price
        ...
        public init(from decoder: Decoder) throws {
            ...
            if let fileData = try container.decodeIfPresent(Data.self, forKey: .file), let file = PostboxDecoder(buffer: MemoryBuffer(data: fileData)).decodeRootObject() as? IosappMediaFile {
                self.file = file
            } else {
        ...
        public init(decoder: PostboxDecoder) {
            ...
            self.file = decoder.decodeObjectForKey(CodingKeys.file.rawValue) as! IosappMediaFile
    ...
    public struct UniqueGift: Equatable, Codable, PostboxCoding {
        ...
        public enum Attribute: Equatable, Codable, PostboxCoding {
            ...
            case model(name: String, file: IosappMediaFile, rarity: Rarity, crafted: Bool)
            case pattern(name: String, file: IosappMediaFile, rarity: Rarity)
            ...
            public init(from decoder: Decoder) throws {
                ...
                case 0:
                    self = .model(
                        ...
                        file: try container.decode(IosappMediaFile.self, forKey: .file),
            ...
            public init(decoder: PostboxDecoder) {
                ...
                case 0:
                    self = .model(
                        ...
                        file: decoder.decodeObjectForKey(CodingKeys.file.rawValue) as! IosappMediaFile,
                        rarity: decodeRarity(),
