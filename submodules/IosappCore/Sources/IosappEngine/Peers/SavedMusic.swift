...
func _internal_getSavedMusicById(postbox: Postbox, network: Network, peer: PeerReference, file: IosappMediaFile) -> Signal<IosappMediaFile?, NoError> {
...
private final class CachedProfileSavedMusic: Codable {
    ...
    init(files: [IosappMediaFile], count: Int32) {
        self.files = files
        self.count = count
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        self.files = try container.decode([IosappMediaFile].self, forKey: .files)
...
public final class ProfileSavedMusicContext {
    public struct State: Equatable {
        ...
        public var files: [IosappMediaFile]
    ...
    public func loadMore(reload: Bool = false) {
        ...
        |> mapToSignal { peer -> Signal<([IosappMediaFile], Int32), MTRpcError> in
