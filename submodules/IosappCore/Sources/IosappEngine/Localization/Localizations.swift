...
func _internal_downloadAndApplyLocalization(accountManager: AccountManager<IosappAccountManagerTypes>, postbox: Postbox, network: Network, languageCode: String) -> Signal<Void, DownloadAndApplyLocalizationError> {
