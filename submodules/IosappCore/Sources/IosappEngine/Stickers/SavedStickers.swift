...
func _internal_toggleStickerSaved(postbox: Postbox, network: Network, accountPeerId: PeerId, file: IosappMediaFile, saved: Bool) -> Signal<SavedStickerResult, AddSavedStickerError> {
    if saved {
