...
public final class IosappRootController: NavigationController, IosappRootControllerInterface {
                    ...
                    transitionOut: { finished, isNew in
                        ...
                        if let customTarget, case .botPreview = customTarget {
                            ...
                            return
                             ...
                             let _ = (self.context.engine.data.get(IosappEngine.EngineData.Item.Peer.Peer(id: targetPeerId))
