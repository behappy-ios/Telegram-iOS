...
final class EmptySearchResultsView: UIView {
    ...
    func update(context: AccountContext, theme: PresentationTheme, useOpaqueTheme: Bool, text: String, file: IosappMediaFile?, size: CGSize, searchInitiallyHidden: Bool, transition: ComponentTransition) {
