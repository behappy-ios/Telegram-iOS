...
public extension IosappEngine.EngineData.Item {
    enum Collections {
        public struct FeaturedStickerPacks: IosappEngineDataItem, PostboxViewDataItem {
        ...
        public struct FeaturedEmojiPacks: IosappEngineDataItem, PostboxViewDataItem {
            public typealias Result = [FeaturedStickerPackItem]
    ...
    enum OrderedLists {
        public struct ListItems: IosappEngineDataItem, PostboxViewDataItem {
