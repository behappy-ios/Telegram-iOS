...
public final class AttachMenuBots: Equatable, Codable {
    public final class Bot: Equatable, Codable {
        ...
        private struct IconPair: Codable {
            ...
            init(_ name: IconName, value: IosappMediaFile) {
                self.name = name
                self.value = value
            }
            ...
            init(from decoder: Decoder) throws {
                ...
                self.value = IosappMediaFile(decoder: PostboxDecoder(buffer: MemoryBuffer(data: data.data)))
            }
        ...
        public let icons: [IconName: IosappMediaFile]
        ...
        public init(
            peerId: PeerId,
            name: String,
            icons: [IconName: IosappMediaFile],
            peerTypes: PeerFlags,
            flags: Flags
        ) {
            self.peerId = peerId
        ...
        public init(from decoder: Decoder) throws {
            ...
            var icons: [IconName: IosappMediaFile] = [:]
                            ...
                            for bot in bots {
                                switch bot {
                                    case let .attachMenuBot(attachMenuBotData):
                                        ...
                                        var icons: [AttachMenuBots.Bot.IconName: IosappMediaFile] = [:]
...
public struct AttachMenuBot: Equatable {
    ...
    public let icons: [AttachMenuBots.Bot.IconName: IosappMediaFile]
    public let peerTypes: AttachMenuBots.Bot.PeerFlags
    public let flags: AttachMenuBots.Bot.Flags
    
    public init(peer: EnginePeer, shortName: String, icons: [AttachMenuBots.Bot.IconName: IosappMediaFile], peerTypes: AttachMenuBots.Bot.PeerFlags, flags: AttachMenuBots.Bot.Flags) {
        self.peer = peer
...
public final class BotApp: Equatable, Codable {
    ...
    public let document: IosappMediaFile?
    public let hash: Int64
    public let flags: Flags
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.photo = try container.decodeIfPresent(IosappMediaImage.self, forKey: .photo)
        self.document = try container.decodeIfPresent(IosappMediaFile.self, forKey: .document)
        self.hash = try container.decode(Int64.self, forKey: .hash)
