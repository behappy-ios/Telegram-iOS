...
final class ThemePreviewControllerNode: ASDisplayNode, ASScrollViewDelegate {
    ...
    public let wallpaperPromise = Promise<IosappWallpaper>()
    ...
    init(context: AccountContext, previewTheme: PresentationTheme, initialWallpaper: IosappWallpaper?, dismiss: @escaping () -> Void, apply: @escaping () -> Void, isPreview: Bool, forceReady: Bool, ready: Promise<Bool>) {
