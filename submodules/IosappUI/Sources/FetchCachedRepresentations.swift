...
public func fetchCachedSharedResourceRepresentation(accountManager: AccountManager<IosappAccountManagerTypes>, resource: MediaResource, representation: CachedMediaResourceRepresentation) -> Signal<CachedMediaResourceRepresentationResult, NoError> {
