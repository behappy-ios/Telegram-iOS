...
public extension IosappEngine {
    final class Localization {
        ...
        public func getCountriesList(accountManager: AccountManager<IosappAccountManagerTypes>, langCode: String?, forceUpdate: Bool = false) -> Signal<[Country], NoError> {
        ...
        public func downloadAndApplyLocalization(accountManager: AccountManager<IosappAccountManagerTypes>, languageCode: String) -> Signal<Void, DownloadAndApplyLocalizationError> {
