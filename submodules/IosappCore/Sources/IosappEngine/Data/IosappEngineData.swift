...
public protocol IosappEngineDataItem {
    associatedtype Result
}

public protocol IosappEngineMapKeyDataItem {
...
protocol PostboxViewDataItem: IosappEngineDataItem, AnyPostboxViewDataItem {
...
public final class EngineDataMap<Item: IosappEngineDataItem & IosappEngineMapKeyDataItem>: IosappEngineDataItem, AnyPostboxViewDataItem {
...
public final class EngineDataList<Item: IosappEngineDataItem & IosappEngineMapKeyDataItem>: IosappEngineDataItem, AnyPostboxViewDataItem {
...
public final class EngineDataOptional<Item: IosappEngineDataItem>: IosappEngineDataItem, AnyPostboxViewDataItem {
    public typealias Result = Item.Result?
...
public extension IosappEngine {
    final class EngineData {
        ...
        /*public func subscribe<each T: IosappEngineDataItem>(_ ts: repeat each T) -> Signal<repeat each T, NoError> {
        }*/

        public func subscribe<T0: IosappEngineDataItem>(_ t0: T0) -> Signal<T0.Result, NoError> {
            return self._subscribe(items: [t0 as! AnyPostboxViewDataItem])
            |> map { results -> T0.Result in
                return results[0] as! T0.Result
            }
        }
        public func get<T0: IosappEngineDataItem>(_ t0: T0) -> Signal<T0.Result, NoError> {
            return self.subscribe(t0)
            |> take(1)
        }

        public func subscribe<
            T0: IosappEngineDataItem,
            T1: IosappEngineDataItem
        >(
            _ t0: T0,
            _ t1: T1
        ) -> Signal<
