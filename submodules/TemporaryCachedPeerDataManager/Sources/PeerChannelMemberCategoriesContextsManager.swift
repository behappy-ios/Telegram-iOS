...
private final class PeerChannelMemberCategoriesContextsManagerImpl {
    ...
    func getContext(engine: IosappEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, key: PeerChannelMemberContextKey, requestUpdate: Bool, count: Int32? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl) {
    ...
    func recentOnline(account: Account, accountPeerId: PeerId, peerId: PeerId, updated: @escaping (Int32) -> Void) -> Disposable {
        ...
        if let current = self.onlineContexts[peerId] {
            ...
            let signal = (
                IosappEngine(account: account).peers.chatOnlineMembers(peerId: peerId)
                |> then(
                    .complete()
...
public final class PeerChannelMemberCategoriesContextsManager {
    ...
    private func getContext(engine: IosappEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, key: PeerChannelMemberContextKey, requestUpdate: Bool, count: Int32? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
        assert(Queue.mainQueue().isCurrent())
    ...
    public func recent(engine: IosappEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, requestUpdate: Bool = true, count: Int32? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func mentions(engine: IosappEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, threadMessageId: MessageId?, searchQuery: String? = nil, requestUpdate: Bool = true, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func admins(engine: IosappEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func contacts(engine: IosappEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func bots(engine: IosappEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func restricted(engine: IosappEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func banned(engine: IosappEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func restrictedAndBanned(engine: IosappEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func updateMemberBannedRights(engine: IosappEngine, peerId: PeerId, memberId: PeerId, bannedRights: IosappChatBannedRights?) -> Signal<Void, NoError> {
    ...
    public func updateMemberRank(engine: IosappEngine, peerId: PeerId, memberId: PeerId, rank: String?) -> Signal<Void, UpdateChatRankError> {
    ...
    public func updateMemberAdminRights(engine: IosappEngine, peerId: PeerId, memberId: PeerId, adminRights: IosappChatAdminRights?, rank: String?) -> Signal<Void, UpdateChannelAdminRightsError> {
    ...
    public func transferOwnership(engine: IosappEngine, peerId: PeerId, memberId: PeerId, password: String) -> Signal<Void, ChatOwnershipTransferError> {
    ...
    public func join(engine: IosappEngine, peerId: PeerId, hash: String?) -> Signal<Never, JoinChannelError> {
    ...
    public func addMember(engine: IosappEngine, peerId: PeerId, memberId: PeerId) -> Signal<Never, AddChannelMemberError> {
    ...
    public func addMembers(engine: IosappEngine, peerId: PeerId, memberIds: [PeerId]) -> Signal<Void, AddChannelMemberError> {
    ...
    public func addMembersAllowPartial(engine: IosappEngine, peerId: PeerId, memberIds: [PeerId]) -> Signal<[(PeerId, AddChannelMemberError)], NoError> {
    ...
    public func recentOnlineSmall(engine: IosappEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId) -> Signal<(total: Int32, recent: Int32), NoError> {
        return Signal { [weak self] subscriber in
            ...
            let disposableAndControl = self?.recent(engine: engine, postbox: postbox, network: network, accountPeerId: accountPeerId, peerId: peerId, updated: { state in
                ...
                if previousIds != updatedIds {
                    ...
                    statusesDisposable.set((engine.data.subscribe(EngineDataMap(
                        updatedIds.map(IosappEngine.EngineData.Item.Peer.Presence.init)
                    ))
