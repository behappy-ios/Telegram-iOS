...
func _internal_updateChannelAdminRights(account: Account, peerId: PeerId, adminId: PeerId, rights: IosappChatAdminRights?, rank: String?) -> Signal<(ChannelParticipant?, RenderedChannelParticipant), UpdateChannelAdminRightsError> {
