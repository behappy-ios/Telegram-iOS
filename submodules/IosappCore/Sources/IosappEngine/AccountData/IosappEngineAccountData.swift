...
public extension IosappEngine {
    final class AccountData {
        ...
        public func updateBirthday(birthday: IosappBirthday?) -> Signal<Never, UpdateBirthdayError> {
        ...
        public func updateAccountPhoto(resource: MediaResource?, videoResource: MediaResource?, videoStartTimestamp: Double?, markup: UploadPeerPhotoMarkup?, mapResourceToAvatarSizes: @escaping (MediaResource, [IosappMediaImageRepresentation]) -> Signal<[Int: Data], NoError>) -> Signal<UpdatePeerPhotoStatus, UploadPeerPhotoError> {
        ...
        public func updatePeerPhotoExisting(reference: IosappMediaImageReference) -> Signal<IosappMediaImage?, NoError> {
            return _internal_updatePeerPhotoExisting(network: self.account.network, reference: reference)
        }

        public func removeAccountPhoto(reference: IosappMediaImageReference?) -> Signal<Void, NoError> {
            return _internal_removeAccountPhoto(account: self.account, reference: reference, fallback: false)
        }
        
        public func updateFallbackPhoto(resource: MediaResource?, videoResource: MediaResource?, videoStartTimestamp: Double?, markup: UploadPeerPhotoMarkup?, mapResourceToAvatarSizes: @escaping (MediaResource, [IosappMediaImageRepresentation]) -> Signal<[Int: Data], NoError>) -> Signal<UpdatePeerPhotoStatus, UploadPeerPhotoError> {
        ...
        public func removeFallbackPhoto(reference: IosappMediaImageReference?) -> Signal<Void, NoError> {
        ...
        public func setEmojiStatus(file: IosappMediaFile?, expirationDate: Int32?) -> Signal<Never, NoError> {
            let peerId = self.account.peerId
        ...
        public func updateAccountBusinessHours(businessHours: IosappBusinessHours?) -> Signal<Never, NoError> {
            let peerId = self.account.peerId
        ...
        public func updateAccountBusinessLocation(businessLocation: IosappBusinessLocation?) -> Signal<Never, NoError> {
            let peerId = self.account.peerId
        ...
        public func updateBusinessGreetingMessage(greetingMessage: IosappBusinessGreetingMessage?) -> Signal<Never, NoError> {
            return _internal_updateBusinessGreetingMessage(account: self.account, greetingMessage: greetingMessage)
        }
        
        public func updateBusinessAwayMessage(awayMessage: IosappBusinessAwayMessage?) -> Signal<Never, NoError> {
            return _internal_updateBusinessAwayMessage(account: self.account, awayMessage: awayMessage)
        }
        
        public func setAccountConnectedBot(bot: IosappAccountConnectedBot?) -> Signal<Never, NoError> {
            return _internal_setAccountConnectedBot(account: self.account, bot: bot)
        }
        
        public func updateBusinessIntro(intro: IosappBusinessIntro?) -> Signal<Never, NoError> {
            return _internal_updateBusinessIntro(account: self.account, intro: intro)
        }
        
        public func createBusinessChatLink(message: String, entities: [MessageTextEntity], title: String?) -> Signal<IosappBusinessChatLinks.Link, AddBusinessChatLinkError> {
            return _internal_createBusinessChatLink(account: self.account, message: message, entities: entities, title: title)
        }
        
        public func editBusinessChatLink(url: String, message: String, entities: [MessageTextEntity], title: String?) -> Signal<IosappBusinessChatLinks.Link, AddBusinessChatLinkError> {
        ...
        public func updatePersonalChannel(personalChannel: IosappPersonalChannel?) -> Signal<Never, NoError> {
