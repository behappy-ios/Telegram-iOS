...
public func addSavedSticker(postbox: Postbox, network: Network, file: IosappMediaFile, limit: Int = 5) -> Signal<Void, AddSavedStickerError> {
...
public func addSavedSticker(transaction: Transaction, file: IosappMediaFile, stringRepresentations: [String], limit: Int = 5) {
