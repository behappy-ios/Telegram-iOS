...
public enum EnginePeer: Equatable {
    ...
    case user(IosappUser)
    case legacyGroup(IosappGroup)
    case channel(IosappChannel)
    case secretChat(IosappSecretChat)
...
public extension EnginePeer.NotificationSettings {
    init(_ notificationSettings: IosappPeerNotificationSettings) {
        self.init(
    ...
    func _asNotificationSettings() -> IosappPeerNotificationSettings {
        return IosappPeerNotificationSettings(
...
public extension EnginePeer.Presence {
    init(_ presence: PeerPresence) {
        if let presence = presence as? IosappUserPresence {
    ...
    func _asPresence() -> IosappUserPresence {
        ...
        return IosappUserPresence(status: mappedStatus, lastActivity: self.lastActivity)
    }
}
...
public extension EnginePeer {
    init(_ peer: Peer) {
        ...
        case let secretChat as IosappSecretChat:
